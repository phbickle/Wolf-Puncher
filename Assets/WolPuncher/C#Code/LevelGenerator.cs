...
public class LevelGenerator : MonoBehaviour
{
	...
	void Start()
	{
       ...
       // mTiles[index].transform.position = new Vector3(2.288179f, 0.2169971f, -12.95014f);
	...
	void InitTile(int index)
	{
       ...
       // mTiles[index].transform.position = currTile_.transform.position;// +new Vector3(2.288179f, 0.2169971f, -12.95014f);
		currTile_ = mTiles[index];
